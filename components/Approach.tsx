    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-y-10 md:gap-x-16 mx-auto md:px-8 select-none">
        <Card
          ...
          des="we are providing online training with course compilation certificate.The course for online training AWS,GEN Ai,Ai, Prompt Engineering,AWS,Python Full Stack, Digital Marketing."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          icon={<AceternityIcon order="Offline/online Training" />}
          des="we are providing offline Training with real time project and certification. And List of course are AWS/Devops,Azure/Devops,GEN Ai,Prompt,Engineering,Cybder Security,Digital Marketing. "
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Projects"
          icon={<AceternityIcon order="Project" />}
          des="We Provide the project will live monitoring with trainer and paper publishing to the above project too."
        >
          <CanvasRevealEffect
            animationSpeed={3}
